<?php /* C:\Users\Akbar Pratama\laravelprojectpos\resources\views/transaksi/index.blade.php */ ?>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($t->tgl); ?></td>
                                                    <td><?php echo e($t->produk->nama_barang); ?></td>
                                                    <td><?php echo e($t->produk->harga); ?></td>
                                                    <td><?php echo e($t->jumlah); ?></td>
                                                    <td><?php echo e($t->total); ?></td>
                                                    <td>
                                                        <a href="/transaksi/<?php echo e($t->id); ?>/detail" class="fa fa-edit">Detail</a>
                                                    </td>
                                                </tr>
